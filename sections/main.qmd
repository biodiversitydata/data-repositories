...
|:------------|:-----------:|------------:|------------:|------------:|------------:|------------:|------------:|
| [InDoRES](https://www.indores.fr/) | CNRS-Ecology, MNHN | thematic ( and institutional) | Ecology, Environment, Bio-archaeology | Environmental, ecological and geographical data | yes | DOI  |2 GB per data set but planned to increase to 4 / 5 |
